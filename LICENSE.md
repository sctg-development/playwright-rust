...
**Original Code**: This project is a fork of [playwright-rust](https://github.com/octaltree/playwright-rust), licensed under Apache 2.0.

**Playwright**: The underlying Playwright framework is developed by Microsoft and available at [microsoft/playwright](https://github.com/microsoft/playwright), also licensed under Apache 2.0.

**Current Maintenance**: Modified and maintained by Ronan Le Meillat for SCTG Development (2025).
...
APPENDIX: How to apply the Apache License to your work.
   ...
   include a file named "LICENSE" (or "COPYING") in the root of your
   source tree.
...
Copyright 2025 Ronan Le Meillat, SCTG Development

Copyright 2020-2024 octaltree (original playwright-rust)

Copyright 2020-2025 Microsoft Corporation (Playwright)

All parts of this software, unless otherwise noted, are under the Apache License 2.0.
```
